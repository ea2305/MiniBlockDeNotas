...
/*		
	private void openFile() {
		...
		A1.setTitle(":v");
        A1.setHeaderText("Hola");
        A1.setContentText("Que onda");
        A1.showAndWait();
	...
	private void saveFile() {
		...
		Alert A1 = new Alert(AlertType.INFORMATION);
		A1.setTitle("Universidad Politécnica de Chiapas");
        A1.setHeaderText("Creditos");
        A1.setContentText("Elihu Alejandro Cruz Albores\nMatricula:143405\nProfesor:Juan Carlos Lopez Pimentel");
        A1.showAndWait();
